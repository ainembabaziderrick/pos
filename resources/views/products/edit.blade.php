                ...
                <div class="card-body">
                    ...
                    <form action=" {{ url('admin/products/update/'.$products->id)}}" method="post" enctype="multipart/form-data">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-10">
                               <textarea name="description" id="" cols="30" rows="3" class="form-control" value=""> {{ $products->description}}</textarea>
                            </div>
                        </div>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-10">
                                <input type="text" name="alert_stock" class="form-control" value="{{ $products->alert_stock}}">
                            </div>
                        </div>
